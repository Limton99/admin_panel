        ...
        <section id="row-selection">
            <div>
                <div id="DataTables_Table_4_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    <a href="{{route('serviceCategories-create')}}" class="btn btn-primary">Добавить категорию</a>
                    <div class="row">
                        <br>
                        <div class="col-sm-12">
                            <table class="table table-striped table-bordered selection-multiple-rows dataTable" id="DataTables_Table_4" role="grid" aria-describedby="DataTables_Table_4_info">
                                ...
                                @foreach($categories as $data)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>{{$data->сommission}}</td>
                                        <td>{{$data->visit_price}}</td>
                                        <td>{{$data->visit_commision}}</td>
                                        <td>
                                            <a href="{{route('serviceCategories-edit', $data->id)}}" class="btn btn-warning"><i class="icon-edit"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
