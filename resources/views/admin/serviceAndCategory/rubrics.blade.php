        ...
        <section id="row-selection">
            <div>
                <div id="DataTables_Table_4_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    <a href="{{route('rubric-create')}}" class="btn btn-primary">Добавить рубрику</a>
                    <div class="row">
                        <br>
                        <div class="col-sm-12">
                            <table class="table table-striped table-bordered selection-multiple-rows dataTable" id="DataTables_Table_4" role="grid" aria-describedby="DataTables_Table_4_info">
                                ...
                                @foreach($rubrics as $data)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <a href="{{route('rubric-edit', $data->id)}}" class="btn btn-warning"><i class="icon-edit"></i></a>
                                            <a href="{{route('rubric-delete', $data->id)}}" class="btn btn-danger"><i class="icon-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
